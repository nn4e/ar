...
<html lang="en">
  ...
  <meta name="request-id" content="BCD2:614D:F068DA:1C32274:5B53052E" data-pjax-transient>
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="html-safe-nonce" content="6fa4b97f4d9d32177e8ea22f1147728651fcd817">
...
>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="2051226" data-scoped-search-url="/eligrey/FileSaver.js/search" data-unscoped-search-url="/search" action="/eligrey/FileSaver.js/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=xxVMv5T/8QYoX1Scl0uDwIst/DfXu4pPgkG0ryhEvBOKl/rrB0c5CHKGLjAPf4iegEYxTridcjVN1tMnY9L2AA=="
          spellcheck="false"
          autocomplete="off"
          >
          ...
          <span class="d-inline-block">
              <div class="HeaderNavlink px-0 py-2 m-0">
                <a class="text-bold text-white no-underline" href="/login?return_to=%2Feligrey%2FFileSaver.js" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in; experiment:site_header_dropdowns; group:control">Sign in</a>
  ...
  <li>
    ...
    <a class="social-count js-social-count" href="/eligrey/FileSaver.js/stargazers"
      aria-label="8622 users starred this repository">
      8,622
    </a>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  <div class="repository-content ">
      ...
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="7nld6a7gH5e47qSsTt1nyKeTQwMTSKtPo0DBvFv+cohkYBUZPnrc+T0Zttbbmx02zjqxo/9KTxT2VJnstKDp0g==" />
...
<div class="AvatarStack flex-self-start ">
  <div class="AvatarStack-body" aria-label="eligrey">

        <a class="avatar" data-skip-pjax="true" data-hovercard-user-id="46995" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/eligrey">
          <img height="20" width="20" alt="@eligrey" src="https://avatars0.githubusercontent.com/u/46995?s=60&amp;v=4" />
</a>  </div>
</div>

    <div class="flex-auto f6 no-wrap mr-3">
      
      <a href="/eligrey/FileSaver.js/commits?author=eligrey"
     class="commit-author tooltipped tooltipped-s user-mention"
     aria-label="View all commits by eligrey">eligrey</a>


  


        <a data-pjax="true" title="Merge pull request #450 from ps011/master

Added import statement in syntax section for ease of use" class="message" href="/eligrey/FileSaver.js/commit/00e540fda507173f83a9408f1604622538d0c81a">Merge pull request</a> <a class="issue-link js-issue-link" data-error-text="Failed to load issue title" data-id="337807063" data-permission-text="Issue title is private" data-url="https://github.com/eligrey/FileSaver.js/issues/450" href="https://github.com/eligrey/FileSaver.js/pull/450">#450</a> <a data-pjax="true" title="Merge pull request #450 from ps011/master

Added import statement in syntax section for ease of use" class="message" href="/eligrey/FileSaver.js/commit/00e540fda507173f83a9408f1604622538d0c81a">from ps011/master</a>
          <span class="hidden-text-expander inline">
            <button type="button" class="ellipsis-expander js-details-target" aria-expanded="false">&hellip;</button>
          </span>

        <div class="commit-desc"><pre class="text-small">Added import statement in syntax section for ease of use</pre></div>
    </div>
    <div class="no-wrap">
      Latest commit
      <a class="commit-tease-sha" href="/eligrey/FileSaver.js/commit/00e540fda507173f83a9408f1604622538d0c81a" data-pjax>
        00e540f
      </a>
      <span itemprop="dateModified"><relative-time datetime="2018-07-17T17:50:43Z">Jul 17, 2018</relative-time></span>
    </div>
  </div>
...
<div class="file-wrap">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/eligrey/FileSaver.js/tree/00e540fda507173f83a9408f1604622538d0c81a">Permalink</a>
...
<span aria-label="This commit closes issue #/eligrey/FileSaver.js/pull/257." class="issue-keyword tooltipped tooltipped-se"><a data-pjax="true" title="Closes #257" class="message" href="/eligrey/FileSaver.js/commit/eb8d76f845ef6ad1e39a840c29bb852098c6a401">Closes</a></span> <a href="https://github.com/eligrey/FileSaver.js/pull/257" class="issue-link js-issue-link" data-error-text="Failed to load issue title" data-id="174603464" data-permission-text="Issue title is private" data-url="https://github.com/eligrey/FileSaver.js/issues/257">#257</a>
        ...
        <tr class="js-navigation-item">
          ...
          <td class="content">
            <span class="css-truncate css-truncate-target"><a class="js-navigation-open" title="README.md" id="04c6e90faac2675aa89e2176d2eec7d8-38dfc7b5edd326225a31438eb659b6121f1b9e6d" href="/eligrey/FileSaver.js/blob/master/README.md">README.md</a></span>
          </td>
          <td class="message">
            <span class="css-truncate css-truncate-target">
                  <a data-pjax="true" title="Added import statement in syntax section for ease of use" class="message" href="/eligrey/FileSaver.js/commit/23d400231f637fb75201dbf54438b8b664b3cabc">Added import statement in syntax section for ease of use</a>
            </span>
          </td>
          <td class="age">
            <span class="css-truncate css-truncate-target"><time-ago datetime="2018-07-03T09:01:01Z">Jul 3, 2018</time-ago></span>
          </td>
        </tr>
        <tr class="js-navigation-item">
          <td class="icon">
...
<h3><a id="user-content-import-saveas-from-file-saver" class="anchor" aria-hidden="true" href="#import-saveas-from-file-saver"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Import saveAs() from file-saver</h3>
<div class="highlight highlight-source-js"><pre><span class="pl-k">import</span> { <span class="pl-smi">saveAs</span> } <span class="pl-k">from</span> <span class="pl-s"><span class="pl-pds">'</span>file-saver/FileSaver<span class="pl-pds">'</span></span>;</pre></div>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.19873s from unicorn-6745b5856-s54sc">GitHub</span>, Inc.</li>
